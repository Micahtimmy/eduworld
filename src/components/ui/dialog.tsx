  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-md bg-surface-lowest rounded-2xl shadow-xl border border-outline-variant',
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 p-1.5 rounded-lg opacity-70 hover:opacity-100 hover:bg-surface-high transition-all">
          <X className="h-4 w-4" />
